...
function HoanNhanLongHuc:OnOpen(scene, npc, player)
	...
	if player:GetFactionID() == 0 then
		...
		if nKQ2 == 2 then
			if nCheckBD > 0 then
				dialog:AddSelection(2, "Vào <color=#FFFF00> Chiến trường Phượng Tường (Kim)</color>")
			else
				dialog:AddSelection(2, "Báo danh <color=#FFFF00> Chiến trường Phượng Tường (Kim)</color>")
			end
		elseif nKQ2 == 3 then
		...
		elseif nKQ2 == 4 then
			if nCheckBD > 0 then
				dialog:AddSelection(2, "Vào <color=#FFFF00> Chiến trường Phượng Tường (Kim)</color> nhận thưởng")
			end
		else
			dialog:AddSelection(2, "Báo danh <color=#FFFF00> Chiến trường Phượng Tường (Kim)</color>")
		end
