namespace GameServer.KiemThe.Entities
{
    ...
    public enum MAGIC_ATTRIB
    {
        ...
        /// Hàn Ngọc Quyết
        /// </summary>
        magic_baotay_hanvu_hanngoc_quyet,
		
        /// <summary>
        /// Du Long Chân Khí
        /// </summary>
        magic_giay_doanvien_dulong_chankhi,
		
        /// <summary>
        /// Thiền Nguyên Tâm Pháp
        /// </summary>
        magic_ao_vuuy_thiennguyen_tamphap,
		
        /// <summary>
        /// Thông Vi Hiển Hóa
        /// </summary>
        magic_non_lanhtho_thongvi_hienhoa,		
		
        /// <summary>
        /// Tử Hà Thần Công
        /// </summary>
        magic_pphong_tuha_thancong,
