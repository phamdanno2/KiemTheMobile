...
namespace GameServer.KiemThe.Core.Task
{
    ...
    public class FirmTaskManager
    {
        ...
        public void FirmTaskProsescc(GameMap map, NPC npc, KPlayer client, TaskCallBack TaskData, int TaskID)
        {
            ...
            if (TaskData != null)
            {
                ...
                // if (client.TaskDataList != null)
                {
					...
					else if (SelectID == 2525) // Nếu là hoàn thành nhanh nhiệm vụ
                    {
        ...
        /// <summary>
        /// Xử Lý hoàn thành nhanh nhiệm vụ
        /// </summary>
        /// <param name="map"></param>
        /// <param name="npc"></param>
        /// <param name="client"></param>
        ...
        public void FastCompleteTask(GameMap map, NPC npc, KPlayer client, int TaskID)
        {
            ...
            // }
                    if ( client.Token < 500)
                    {
                        PlayerManager.ShowNotification(client, "Số đồng mang theo không đủ 500 !");
                        return;
                    }
            ...
            if (!KTGlobal.IsHaveSpace(3, client))
            {
                KT_TCPHandler.CloseDialog(client);
            ...
            else
            {
                ...
                if (ProcessTask.FastComplete(Global._TCPManager.MySocketListener, pool, client, npc.ResID, npc.ResID, _TaskFind.ID, taskData.DbID, true))
                {
                    ...
                    KT_TCPHandler.CloseDialog(client);
					/// Trừ đồng
                    KTGlobal.SubMoney(client, 500, Entities.MoneyType.Dong, "SpecialEvent");
        ...
        public void GetNpcDataQuest(GameMap map, NPC npc, KPlayer client)
        {
            ...
            string PhanThuong = "Phần Thưởng  : " + KTGlobal.CreateStringByColor("100.000 Exp", ColorType.Green) + " cho mỗi nhiệm vụ hoàn thành\n";
            ...
            if (findTaskClient != null)
            {
                if (TaskManager.getInstance().IsQuestComplete(findTaskClient.DoingTaskID, findTaskClient.DoingTaskVal1))
                {
					...
					Selections.Add(2525, KTGlobal.CreateStringByColor("Hoàn Thành Nhanh (500 đồng)", ColorType.Done));
            }
            else
            {
