...
namespace FSPlay.GameEngine.Teleport
{
    /// <summary>
    ...
    public class GTeleport : IObject
	{
        ...
        public void Start()
        {
            ...
            //KiemVu.Control.Component.Teleport teleport = Object2DFactory.MakeTeleport();
            KiemVu.Control.Component.Teleport teleport = KTObjectPoolManager.Instance.Instantiate<KiemVu.Control.Component.Teleport>("Teleport");
            ...
            teleport.MinimapIconSize = new Vector2(250f, 250f);
        ...
        public void Destroy()
        {
            ...
            if (null != this.Role2D)
            {
                this.Role2D.GetComponent<KiemVu.Control.Component.Teleport>().Destroy();
                this.Role2D = null;
            }
        }
