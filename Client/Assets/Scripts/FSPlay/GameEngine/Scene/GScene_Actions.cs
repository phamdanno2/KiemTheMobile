    ...
    public partial class GScene
    {
        ...
        public void GrowPointClick(GSprite sprite, Action callback = null)
        {
            ...
            if (distance <= 50)
            {
                ...
                KT_TCPHandler.GrowPointClick(sprite.RoleID - SpriteBaseIds.GrowPointBaseId);
        ...
        public void DropItemClick(GGoodsPack goodsPack)
        {
            ...
            if (distance <= 50)
            {
                ...
                GameInstance.Game.SpriteGetThing(goodsPack.AutoID, goodsPack.GoodsID);
            }
        ...
        public void OtherRoleClick(GSprite sprite)
        {
            ...
            PlayZone.GlobalPlayZone.NotifyRoleFace(sprite.RoleID, -1, true);
        ...
        public void PlayerShopClick(GSprite sprite)
        {
            ...
            if (distance <= 50)
            {
                ...
                PlayZone.GlobalPlayZone.RequestOpenTargetShop(sprite.RoleID);
            }
