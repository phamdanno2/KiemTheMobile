...
namespace FSPlay.GameEngine.Scene
{
    ...
    public partial class GScene
    {
        ...
        public GSprite LoadBot(RoleData rd)
        {
            ...
            sprite.OldGridX = rd.PosX / CurrentMapData.GridSizeX;
            sprite.OldGridY = rd.PosY / CurrentMapData.GridSizeX;
            sprite.SpriteType = GSpriteTypes.Bot;
            sprite.CoordinateChanged += (sender) =>
            {
                this.UpdateBotEvent(sender);
            };
			...
			this.LoadSprite(
                ...
                null,
                null,
                (KiemVu.Entities.Enum.Direction) rd.RoleDirection,
                rd.PosX,
                rd.PosY
            );
            ...
            KiemVu.Control.Component.Character role = KTObjectPoolManager.Instance.Instantiate<KiemVu.Control.Component.Character>("Bot");
            role.name = name;
            ...
            Dictionary<KiemVu.Entities.Enum.KE_EQUIP_POSITION, GoodsData> equips = KTGlobal.GetEquips(rd);
        ...
        /// <summary>
        /// Cập nhật sự kiện BOT
        /// </summary>
        /// <param name="sprite"></param>
        private void UpdateBotEvent(GSprite sprite)
        {
        ...
        /// <returns></returns>
        public bool DelBot(int mapCode, int roleID)
        {
