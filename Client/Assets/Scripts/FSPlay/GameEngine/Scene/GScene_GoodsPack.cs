...
namespace FSPlay.GameEngine.Scene
{
    ...
    public partial class GScene
    {
        ...
        public GGoodsPack LoadGoodsPack(NewGoodsPackData gpData)
        {
            ...
            goodsPack.BaseID = SpriteBaseIds.GoodsPackBaseId + gpData.AutoID;
            goodsPack.Name = name;
            goodsPack.AutoID = gpData.AutoID;
            goodsPack.GoodsID = gpData.GoodsID;
            goodsPack.OwnerID = gpData.OwnerRoleID;
            goodsPack.TeamID = gpData.TeamID;
            ...
            KiemVu.Control.Component.Item itemObj = KTObjectPoolManager.Instance.Instantiate<KiemVu.Control.Component.Item>("Item");
            itemObj.name = name;
