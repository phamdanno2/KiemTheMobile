...
namespace FSPlay.GameEngine.Sprite
{
    ...
    public partial class GSprite
    {
        ...
        public void AddBuff(int buffID, long durationTicks)
        {
            ...
            {
                this.ComponentCharacter.AddEffect(buffID, KiemVu.Entities.Enum.EffectType.Buff);
            }
            else if (this.ComponentMonster != null)
            {
                this.ComponentMonster.AddEffect(buffID, KiemVu.Entities.Enum.EffectType.Buff);
            }
        }
