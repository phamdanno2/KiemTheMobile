...
namespace GameServer.Logic
{
    ...
    public static class StdErrorCode
    {
        ...
        public const int Error_Denied_In_Current_Map = -21; //当前地图不允许此操作
        public const int Error_Player_Count_Limit = -22; //参与者数量已满
        public const int Error_SpecJiFen_Not_Enough = -24;//专享积分不足
        ...
        public const int Error_ZhanMeng_Not_Allowed_Change_ShengYuChengZhu = -1007; //圣域领主持有期间不能委任其他成员为战盟首领
        ...
        public const int Error_Server_Connections_Limit = -100; //服务器连接数达到上限(login_on2指令)
