...
namespace Assets.Scripts.FSPlay.KiemVu.Entities.Config
{
    /// <summary>
    ...
    public class ActivityXML
    {
        ...
        /// <summary>
        /// Tip (nếu có thì sẽ thay thế sự kiện Click di chuyển đến NPC bằng hiện Tip)
        /// </summary>
        ...
        public static ActivityXML Parse(XElement xmlNode)
        {
            ...
            ActivityXML activity = new ActivityXML()
            {
                ...
                State = (ActivityState) Enum.Parse(typeof(ActivityState), xmlNode.Attribute("_State").Value),
