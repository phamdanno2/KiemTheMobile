...
namespace FSPlay.KiemVu.Entities.Config
{
    ...
    public class Map
    {
        ...
        /// <summary>
        /// Đường dẫn file quy định các khối Block ở Bundle
        /// </summary>
        public string Obstruction { get; set; }

        /// <summary>
        /// Đường dẫn file quy định danh sách các điểm truyền tống ở Bundle
        /// </summary>
        public string Teleport { get; set; }

        /// <summary>
        /// Đường dẫn file quy định danh sách các điểm vùng ở Bundle
        /// </summary>
        public string Zone { get; set; }

        /// <summary>
        /// Đường dẫn file quy định danh sách NPC trên bản đồ nhỏ ở Bundle
        /// </summary>
        ...
        /// <summary>
        /// Đường dẫn file quy định danh sách điểm thu thập trên bản đồ nhỏ ở Bundle
        /// </summary>
        public string GrowPointList { get; set; }

        /// <summary>
        /// Đường dẫn file quy định thiết lập bản đồ
        /// </summary>
        ...
        public static Map Parse(XElement xmlNode)
        {
            ...
            return new Map
            {
                ...
                Obstruction = xmlNode.Attribute("Obstruction").Value,
                Teleport = xmlNode.Attribute("teleports").Value,
                Zone = xmlNode.Attribute("zones").Value,
                NPCList = xmlNode.Attribute("npcs").Value,
                MonsterList = xmlNode.Attribute("Monsters").Value,
                GrowPointList = xmlNode.Attribute("GrowPoints").Value,
                MapSetting = xmlNode.Attribute("Setting").Value,
