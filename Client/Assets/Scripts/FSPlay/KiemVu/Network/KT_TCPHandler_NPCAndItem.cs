...
namespace FSPlay.KiemVu.Network
{
    ...
    public static partial class KT_TCPHandler
    {
        ...
        public static void ReceiveOpenNPCDialog(int cmdID, byte[] bytes, int length)
        {
            ...
            PlayZone.GlobalPlayZone.ShowNPCLuaDialog(result.NPCID, result.ID, result.Text, result.Selections, result.Items, result.ItemSelectable, result.OtherParams);
        }
        ...
        public static void ReceiveOpenItemDialog(int cmdID, byte[] bytes, int length)
        {
            ...
            PlayZone.GlobalPlayZone.ShowNPCLuaDialog(result.ItemID, result.DbID, result.ID, result.Text, result.Selections, result.Items, result.ItemSelectable, result.OtherParams);
        }
        ...
        public static void ReceiveCloseDialog()
        {
            ...
            PlayZone.GlobalPlayZone.CloseNPCDialog();
        }
        #endregion
