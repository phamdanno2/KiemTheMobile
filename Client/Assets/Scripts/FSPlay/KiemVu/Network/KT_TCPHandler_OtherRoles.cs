    ...
    public static partial class KT_TCPHandler
    {
        ...
        public static void ReceiveBrowsePlayer(int cmdID, byte[] bytes, int length)
        {
            try
            {
                ...
                /// Nếu chưa hiện khung
                if (PlayZone.GlobalPlayZone.UIBrowsePlayer == null)
                {
                    PlayZone.GlobalPlayZone.ShowUIBrowsePlayer();
                }
                PlayZone.GlobalPlayZone.UIBrowsePlayer.Players = roleDatas;
            }
            catch (Exception) { }
        }
        ...
        public static void ReceiveCheckPlayerLocation(int cmdID, byte[] bytes, int length)
        {
            try
            {
                ...
                if (PlayZone.GlobalPlayZone.UIBrowsePlayer != null)
                {
                    PlayZone.GlobalPlayZone.UIBrowsePlayer.ShowPlayerLocationReport(roleData);
                }
            }
            catch (Exception) { }
        }
        ...
        public static void ReceiveCheckPlayerInfo(int cmdID, byte[] bytes, int length)
        {
            ...
            {
                RoleDataMini roleData = DataHelper.BytesToObject<RoleDataMini>(bytes, 0, length);
                PlayZone.GlobalPlayZone.OpenUIPlayerInfo(roleData);
            }
            catch (Exception) { }
        }
        #endregion
        ...
        public static void ReceiveGetOtherPlayerEquipInfo(int cmdID, byte[] bytes, int length)
        {
            try
            {
                ...
                if (PlayZone.GlobalPlayZone.UIOtherRoleInfo == null)
                {
                    PlayZone.GlobalPlayZone.OpenUIOtherRoleInfo(roleData);
                }
            }
            catch (Exception) { }
        }
        ...
        public static void ReceivePlayerRanking(int cmdID, byte[] bytes, int length)
        {
            ...
            if (PlayZone.GlobalPlayZone.UIRanking != null)
            {
                KTGlobal.HideLoadingFrame();

                PlayZone.GlobalPlayZone.UIRanking.Data = ranking;
                PlayZone.GlobalPlayZone.UIRanking.RefreshData();
            }
        }
        #endregion
    }
