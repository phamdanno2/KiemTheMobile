...
namespace FSPlay.KiemVu.Network
{
    ...
    public static partial class KT_TCPHandler
    {
        ...
        public static void ReceiveSignetEnhance(string[] fields)
        {
            ...
            if (ret == 1)
            {
                if (PlayZone.GlobalPlayZone.UISignetEnhance != null)
                {
                    PlayZone.GlobalPlayZone.UISignetEnhance.EmptyFiveElementsStoneList();
                    /// Thực thi hiệu ứng cường hóa thành công
                    PlayZone.GlobalPlayZone.UISignetEnhance.PlaySignetEnhanceSuccessEffect();
                    PlayZone.GlobalPlayZone.UISignetEnhance.RefreshEnhanceEquip();
                }
            }
        }
        #endregion
        ...
        public static void ReceiveEquipEnhance(string[] fields)
        {
            ...
            if (ret != -1)
            {
                if (PlayZone.GlobalPlayZone.UIEnhance != null)
                {
                    PlayZone.GlobalPlayZone.UIEnhance.EmptyCrystalStoneGrid();
                    /// Nếu cường hóa thành công thì thực thi hiệu ứng
                    if (ret == 1)
                    {
                        PlayZone.GlobalPlayZone.UIEnhance.PlayEquipEnhanceSuccessEffect();
                        PlayZone.GlobalPlayZone.UIEnhance.RefreshEnhanceEquip();
                    }
                }
            }
        }
        ...
        public static void ReceiveComposeCrystalStones(string[] fields)
        {
            ...
            if (ret == 1)
            {
                if (PlayZone.GlobalPlayZone.UICrystalStoneSynthesis != null)
                {
                    PlayZone.GlobalPlayZone.UICrystalStoneSynthesis.EmptyFrame();
                }
            }
        }
        ...
        public static void ReceiveSplitCrystalStones(string[] fields)
        {
            ...
            if (ret == 1)
            {
                if (PlayZone.GlobalPlayZone.UISplitEquipCrystalStones != null)
                {
                    PlayZone.GlobalPlayZone.UISplitEquipCrystalStones.EmptyCrystalStoneGrid();
                    PlayZone.GlobalPlayZone.UISplitEquipCrystalStones.RefreshEquip();
                }
                if (PlayZone.GlobalPlayZone.UISplitCrystalStone != null)
                {
                    PlayZone.GlobalPlayZone.UISplitCrystalStone.EmptyCrystalStoneGrid();
                    PlayZone.GlobalPlayZone.UISplitCrystalStone.RemoveSourceCrystalStone();
                }
            }
        }
		#endregion
		...
		{
            /// Đóng khung
            PlayZone.GlobalPlayZone.CloseUIEquipLevelUp();
        }
		#endregion
        ...
        {
            /// Nếu đang mở khung
            if (PlayZone.GlobalPlayZone.UIEquipRefineToFS != null)
			{
                PlayZone.GlobalPlayZone.UIEquipRefineToFS.ClearData();
			}
        }
        #endregion
    }
