    ...
    public static partial class KT_TCPHandler
    {
        ...
        public static void ReceiveEventNotification(int cmdID, byte[] bytes, int length)
        {
            try
            {
                ...
                /// Nếu khung tồn tại
                if (PlayZone.GlobalPlayZone.UIEventBroadboardMini != null)
                {
                    /// Cập nhật hiển thị
                    PlayZone.GlobalPlayZone.UIEventBroadboardMini.EventName = notification.EventName;
                    PlayZone.GlobalPlayZone.UIEventBroadboardMini.ShortDesc = notification.ShortDetail;
                    PlayZone.GlobalPlayZone.UIEventBroadboardMini.CustomContents = notification.TotalInfo;
                }
            }
            catch (Exception) { }
        }
        ...
        public static void ReceiveEventStateChange(int cmdID, byte[] bytes, int length)
        {
            try
            {
                ...
                if (PlayZone.GlobalPlayZone.UIEventBroadboardMini != null)
                {
                    ...
                    {
                        /// Hiện lên
                        PlayZone.GlobalPlayZone.UIEventBroadboardMini.gameObject.SetActive(true);
                        PlayZone.GlobalPlayZone.UIEventBroadboardMini.EventName = "";
                        PlayZone.GlobalPlayZone.UIEventBroadboardMini.CustomContents = new List<string>();
                        PlayZone.GlobalPlayZone.UIEventBroadboardMini.ShortDesc = "";
                        /// Ẩn khung Mini
                        PlayZone.GlobalPlayZone.UIMiniTaskAndTeamFrame.gameObject.SetActive(false);
                        /// Ẩn khung người chơi xung quanh
                        PlayZone.GlobalPlayZone.UINearbyPlayer.Hide();

                        /// Hiện Button tương ứng
                        PlayZone.GlobalPlayZone.UISpecialEventButtons.SetButtonState(state.EventID, true);
                    }
                    /// Nếu là ẩn
                    else
                    {
                        /// Ẩn đi
                        PlayZone.GlobalPlayZone.UIEventBroadboardMini.gameObject.SetActive(false);
                        /// Hiện khung Mini
                        PlayZone.GlobalPlayZone.UIMiniTaskAndTeamFrame.gameObject.SetActive(true);
                        /// Ẩn khung người chơi xung quanh
                        PlayZone.GlobalPlayZone.UINearbyPlayer.Hide();

                        /// Ẩn Button tương ứng
                        PlayZone.GlobalPlayZone.UISpecialEventButtons.SetButtonState(state.EventID, false);
                    }
                }
            }
            catch (Exception) { }
        ...
        public static void ReceiveStreakKill(int cmdID, byte[] bytes, int length)
        {
            try
            {
                ...
                /// Hiển thị khung
                if (PlayZone.GlobalPlayZone.UIStreakKillNotification != null)
                {
                    PlayZone.GlobalPlayZone.UIStreakKillNotification.KillNumber = streakInfo.KillNumber;
                    PlayZone.GlobalPlayZone.UIStreakKillNotification.Show();
                }
            }
            catch (Exception) { }
        }
