...
namespace FSPlay.KiemVu.Control.Component
{
    ...
    public partial class Teleport
    {
        ...
        public void Stand()
        {
            ...
            this.actionCoroutine = this.StartCoroutine(this.animation.DoActionAsync(Entities.Enum.MonsterActionType.NormalStand, Entities.Enum.Direction.DOWN, 1f, true, 0f));
        }
