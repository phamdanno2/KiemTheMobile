...
namespace FSPlay.KiemVu.Control.Component
{
    ...
    public partial class Monster
    {
        ...
        public void Stand()
        {
            ...
            this.actionCoroutine = this.StartCoroutine(this.animation.DoActionAsync(Entities.Enum.MonsterActionType.NormalStand, this.Direction, KTGlobal.StandActionTime, true, 0f));
        ...
        public void FightStand()
        {
            ...
            this.actionCoroutine = this.StartCoroutine(this.animation.DoActionAsync(Entities.Enum.MonsterActionType.FightStand, this.Direction, KTGlobal.StandActionTime, true, 0f));
        ...
        public void Run()
        {
            ...
            this.actionCoroutine = this.StartCoroutine(this.animation.DoActionAsync(Entities.Enum.MonsterActionType.Run, this.Direction, framePlaySpeed, true));
        ...
        public void Attack(float framePlaySpeed)
        {
            ...
            this.actionCoroutine = this.StartCoroutine(this.animation.DoActionAsync(Entities.Enum.MonsterActionType.NormalAttack, this.Direction, framePlaySpeed, false, 0, true, () => {
            }));
        ...
        public void SpecialAttack(float framePlaySpeed)
        {
            ...
            this.actionCoroutine = this.StartCoroutine(this.animation.DoActionAsync(Entities.Enum.MonsterActionType.CritAttack, this.Direction, framePlaySpeed, false, 0, true, () => {
            }));
        ...
        public void RunAttack(float framePlaySpeed)
        {
            ...
            this.actionCoroutine = this.StartCoroutine(this.animation.DoActionAsync(Entities.Enum.MonsterActionType.RunAttack, this.Direction, framePlaySpeed, true));
        ...
        public void Hurt(float framePlaySpeed)
        {
            ...
            this.actionCoroutine = this.StartCoroutine(this.animation.DoActionAsync(Entities.Enum.MonsterActionType.Wound, this.Direction, framePlaySpeed, false, 0, false));
