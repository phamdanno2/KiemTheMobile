        ...
        private IEnumerator StartDownload(Entities.Config.Map mapData, Action done)
        {
            ...
            if (Global.Data.CurrentDownloadingMapName == mapResFolderName)
            {
                ...
                while (Global.Data.CurrentDownloadingMapName == mapResFolderName)
                {
                    ...
                    this.ReportProgress?.Invoke(Global.Data.CurrentDownloadingMapProgress, "Đang tải tài nguyên bản đồ, xin chờ giây lát...");
                    /// Bỏ qua Frame
                    yield return null;
                }
            ...
            /// Cập nhật Text đang tải
            this.ReportProgress?.Invoke(0, "Đang tải tài nguyên bản đồ, xin chờ giây lát...");
            /// Thực hiện tải File
            ...
            downloader.PreportProgress = (percent) => {
                /// Cập nhật Text đang tải
                this.ReportProgress?.Invoke((int) percent, "Đang tải tài nguyên bản đồ, xin chờ giây lát...");
            ...
            /// Cập nhật Text đang tải
            this.ReportProgress?.Invoke((int) 100, "Đang giải nén tài nguyên bản đồ...");
