...
namespace FSPlay.KiemVu.Control.Component
{
    ...
    public static partial class SkillManager
    {
        ...
        public static void Refresh()
        {
            ...
            {
                PlayZone.GlobalPlayZone.StopCoroutine(SkillManager.autoCollectGarbageCoroutine);
            }
            SkillManager.autoCollectGarbageCoroutine = PlayZone.GlobalPlayZone.StartCoroutine(SkillManager.AutoCollectGarbage());
        }
    }
}
