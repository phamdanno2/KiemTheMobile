...
namespace FSPlay.KiemVu.Control.Component
{
    ...
    public static partial class SkillManager
    {
        ...
        public static void CreateBullet(GSprite caster, float delay, int bulletID, int resID, Vector2 fromPos, Vector2 toPos, float velocity, bool repeatAnimation = true)
        {
