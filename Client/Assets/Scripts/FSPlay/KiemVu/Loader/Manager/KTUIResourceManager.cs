...
namespace FSPlay.KiemVu.Utilities.UnityUI
{
    ...
    public class KTUIResourceManager : MonoBehaviour
    {
        ...
        /// <returns></returns>
        public UnityEngine.Sprite GetSprite(string bundleDir, string atlasName, string spriteName)
        {
        ...
        /// <summary>
        /// Trả về tổng số tham chiếu hiện tại đến Bundle tương ứng
        /// </summary>
        /// <param name="bundleDir"></param>
        /// <returns></returns>
        public int GetAssetBundleReferenceCount(string bundleDir)
		{
            if (!this.listBundles.ContainsKey(bundleDir))
            {
                return 0;
            }
            return this.listBundles[bundleDir].ReferenceCount;
        }
        #endregion
    }
}