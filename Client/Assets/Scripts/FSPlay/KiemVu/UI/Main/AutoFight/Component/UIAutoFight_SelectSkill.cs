...
namespace FSPlay.KiemVu.UI.Main.AutoFight
{
    ...
    public class UIAutoFight_SelectSkill : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        private UIButtonSprite UIButton_SkillPrefab;
        #endregion
        ...
        {
            UIButtonSprite uiButtonSkill = GameObject.Instantiate<UIButtonSprite>(this.UIButton_SkillPrefab);
            uiButtonSkill.gameObject.SetActive(true);
            uiButtonSkill.transform.SetParent(this.transformSkillList, false);

            uiButtonSkill.BundleDir = skillData.IconBundleDir;
            uiButtonSkill.AtlasName = skillData.IconAtlasName;
            uiButtonSkill.NormalSpriteName = skillData.Icon;
            uiButtonSkill.DisabledSpriteName = skillData.Icon;
