...
namespace FSPlay.KiemVu.UI.Main.MainUI
{
    ...
    public class UIControlButtons : MonoBehaviour
    {
        ...
        /// <summary>
        /// Nút mở khung gia tộc
        /// </summary>
        [SerializeField]
        private UIHintButton UIButton_FamilyManager;
        ...
        /// </summary>
        public Action OpenFamilyManager { get; set; }
        ...
        private void InitPrefabs()
        {
            ...
            this.UIButton_FamilyManager.Click = this.ButtonOpenFamilyManager_Clicked;
        ...
        /// <summary>
        /// Sự kiện khi Button mở khung gia tộc được ấn
        /// </summary>
        private void ButtonOpenFamilyManager_Clicked()
        {
            this.OpenFamilyManager?.Invoke();
        }
