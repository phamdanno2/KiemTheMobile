...
namespace FSPlay.KiemVu.UI.Main.LocalMap
{
    ...
    public class UILocalMap_LocalMapTab : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        private TMP_InputField UIInput_PosX;

        /// <summary>
        /// Vị trí muốn đến Y
        /// </summary>
        [SerializeField]
        private TMP_InputField UIInput_PosY;

        /// <summary>
        /// Button dịch đến vị trí chỉ định
        /// </summary>
        [SerializeField]
        private UnityEngine.UI.Button UIButton_GoToPos;
        #endregion
        ...
        {
            this.InitPrefabs();
            this.UpdateLeaderLocation(this._LeaderPosition);
        ...
        private void InitPrefabs()
        {
            ...
            this.UIButton_GoToPos.onClick.AddListener(this.ButtonGoToPos_Clicked);
        }

        /// <summary>
        /// Sự kiện khi Button dịch đến vị trí chỉ định được ấn
        /// </summary>
        private void ButtonGoToPos_Clicked()
        {
            try
            {
                int posX = int.Parse(this.UIInput_PosX.text);
                int posY = int.Parse(this.UIInput_PosY.text);
            ...
            {
                KTGlobal.AddNotification("Hãy nhập vào đúng định dạng tọa độ X và Y nơi cần đến.");
            }
        }
        ...
        private void DisplayNPCTaskStates()
        {
            ...
            if (Global.Data.RoleData.NPCTaskStateList != null)
            {
                ...
                {
                    /// Nếu NPC tồn tại
                    if (Global.Data.GameScene.CurrentMapData.NpcListByID.TryGetValue(state.NPCID, out Point pos))
                    {
        ...
        {
            Vector2 leaderPos = this.WorldPosToLocalMapPos(this._LeaderPosition);
        ...
        private void UpdateLeaderLocation(Vector2 position)
        {
            ...
            {
                this.leaderIconRectTransform.anchoredPosition = this.WorldPosToLocalMapPos(position);
            }
        }
