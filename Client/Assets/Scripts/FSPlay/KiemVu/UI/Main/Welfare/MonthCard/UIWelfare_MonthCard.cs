...
namespace FSPlay.KiemVu.UI.Main.Welfare.MonthCard
{
	/// <summary>
	/// Phúc lợi thẻ tháng
	/// </summary>
	public class UIWelfare_MonthCard : MonoBehaviour
	{
		...
		/// </summary>
		[SerializeField]
		private TextMeshProUGUI UIText_Slogan;
		...
		private void AddItem(Card data)
		{
			...
			uiItemBox.AlreadyGotten = this.Data.GetStateAtDay(data.Day) == 1;
			uiItemBox.CanGet = this.Data.GetStateAtDay(data.Day) == 0;
			uiItemBox.Click = () => {
		...
		private void DoRefresh()
		{
			...
			/// Ẩn Hint thẻ tháng
			PlayZone.GlobalPlayZone.UIWelfare.HintMonthCard(false);
