...
using FSPlay.KiemVu.UI.Main.Welfare.SeriesLogin;
using Server.Data;
using System;
...
{
    /// <summary>
    /// Khung phúc lợi đăng nhập liên tiếp
    /// </summary>
    public class UIWelfare_SeriesLogin : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        private UIWelfare_SeriesLogin_ListAward UI_ItemListPrefab;

        /// <summary>
        /// Thông tin đã đăng nhập liên tiếp
        /// </summary>
        [SerializeField]
        private TextMeshProUGUI UIText_SeriesLoginInfo;
        #endregion
        ...
        #region Properties
        /// <summary>
        /// Thông tin đăng nhập liên tiếp
        /// </summary>
        public TotalDayLoginSeries Data { get; set; }

        /// <summary>
        /// Truy vấn thông tin đăng nhập liên tiếp
        /// </summary>
        public Action QueryGetSeriesLoginInfo { get; set; }

        /// <summary>
        /// Sự kiện nhận vật phẩm ở mốc tương ứng
        /// </summary>
        public Action<Gift> Get { get; set; }
        #endregion
        ...
        private void Start()
        {
            ...
            this.QueryGetSeriesLoginInfo?.Invoke();
        }
        #endregion
        ...
        private void AddAward(Gift awardInfo)
        {
            ...
            UIWelfare_SeriesLogin_ListAward uiAwardList = GameObject.Instantiate<UIWelfare_SeriesLogin_ListAward>(this.UI_ItemListPrefab);
            ...
            uiAwardList.Day = awardInfo.TimeOl;
        ...
        /// </summary>
        /// <param name="id"></param>
        private UIWelfare_SeriesLogin_ListAward FindAward(int id)
        {
            foreach (Transform child in this.transformItemList.transform)
            {
                if (child.gameObject != this.UI_ItemListPrefab.gameObject)
                {
                    UIWelfare_SeriesLogin_ListAward uiSlotItem = child.GetComponent<UIWelfare_SeriesLogin_ListAward>();
                    if (uiSlotItem.ID == id)
                    {
                        return uiSlotItem;
                    }
        ...
        public void Refresh()
        {
            ...
            this.UIText_SeriesLoginInfo.text = "";

            /// Nếu không có dữ liệu
            if (this.Data == null)
            {
                KTGlobal.AddNotification("Có lỗi khi tải dữ liệu phúc lợi đăng nhập tích lũy, hãy báo hỗ trợ để được trợ giúp!");
                this.UIText_SeriesLoginInfo.text = "Có lỗi khi tải dữ liệu phúc lợi đăng nhập tích lũy, hãy báo hỗ trợ để được trợ giúp!";
            ...
            if (!this.Data.IsOpen)
            {
                ...
                this.UIText_SeriesLoginInfo.text = "Phúc lợi này chưa được mở!";
                return;
            }

            /// Cập nhật thông tin tổng thời gian đã đăng nhập
            this.UIText_SeriesLoginInfo.text = string.Format("Bạn đã đăng nhập liên tiếp <color=green>{0} ngày</color>.{1}", this.Data.LoginNum, this.Data.HasSomethingToGet ? "Nhấn <color=yellow>Nhận</color> tại mốc tương ứng để nhận quà." : "");

            /// Xây danh sách quà
            foreach (Gift itemInfo in this.Data.Gift)
            {
            ...
            if (PlayZone.GlobalPlayZone.UIWelfare != null)
            {
                ...
                PlayZone.GlobalPlayZone.UIWelfare.HintSeriesLogin(this.Data.HasSomethingToGet);
            }
        ...
        {
            UIWelfare_SeriesLogin_ListAward uiAwardInfo = this.FindAward(id);
            if (uiAwardInfo != null)
            {
