...
using FSPlay.KiemVu.UI.Main.TaskBox;
using Server.Data;
using System;
...
namespace FSPlay.KiemVu.UI.Main
{
    ...
    public class UITaskBox : MonoBehaviour
    {
        ...
        private void ToggleTask_Clicked(UITaskBox_Task uiTask)
        {
            ...
            {
                awardMoneyAndExpString.Add(string.Format("Đồng khóa: <color=#faed00>{0}</color>", KTGlobal.GetDisplayMoney(uiTask.Data.DongKhoa)));
            }
        ...
        private UITaskBox_TaskCategory AddCategory(int id, string name, bool isSelected = false)
        {
        ...
        private void BuildCategories()
        {
            ...
            this.AddCategory(0, "Chính tuyến", true);
            this.BuildTaskTree(0, true);
            this.AddCategory(5, "Phụ tuyến", false);
