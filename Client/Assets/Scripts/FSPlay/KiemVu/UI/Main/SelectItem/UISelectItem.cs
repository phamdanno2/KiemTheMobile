...
namespace FSPlay.KiemVu.UI.Main.MainUI.RadarMap
{
    ...
    public class UISelectItem : MonoBehaviour
    {
        ...
        private void AddItem(GoodsData itemGD)
        {
            ...
            UIButtonSprite uiButton = GameObject.Instantiate<UIButtonSprite>(this.UIButton_ItemPrefab);
            uiButton.transform.SetParent(this.uiTransform_ListItems, false);
            uiButton.gameObject.SetActive(true);
            uiButton.BundleDir = itemData.IconBundleDir;
            uiButton.AtlasName = itemData.IconAtlasName;
            uiButton.NormalSpriteName = itemData.Icon;
            uiButton.DisabledSpriteName = itemData.Icon;
            uiButton.Click = () => {
                this.Hide();
