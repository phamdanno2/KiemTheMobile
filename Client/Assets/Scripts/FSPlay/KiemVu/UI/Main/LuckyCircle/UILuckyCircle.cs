...
using UnityEngine;
using TMPro;
using FSPlay.KiemVu.UI.Main.LuckyCircle;
...
namespace FSPlay.KiemVu.UI.Main
{
    ...
    public class UILuckyCircle : MonoBehaviour
    {
        ...
        private IEnumerator DoStartTurn(int stopPos, int durationSec)
        {
            ...
            /// Thiết lập Text
            this.UIText_AwardInfo.text = "Mỗi lượt quay tiêu hao <color=yellow>1000 Đồng</color><br>Ấn <color=green>Rút thăm</color> để bắt đầu quay.";
