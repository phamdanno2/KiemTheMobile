...
namespace FSPlay.KiemVu.UI.Main.SkillTree
{
    /// <summary>
    ...
    public class UISkillTree : MonoBehaviour
    {
        ...
        private void ButtonAccept_Clicked()
        {
            ...
            if (Global.Data.RoleData.SubID == 0 && this.selectedSub != null)
            {
                KTGlobal.ShowMessageBox("Xác nhận chọn nhánh phái <color=yellow>" + this.selectedSub.Name + "</color>?", () => {
