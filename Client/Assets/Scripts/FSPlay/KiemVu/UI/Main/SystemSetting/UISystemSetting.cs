...
namespace FSPlay.KiemVu.UI.Main
{
    ...
    public class UISystemSetting : MonoBehaviour
    {
        ...
        /// <summary>
        /// Slider chất lượng hiển thị hiệu ứng
        /// </summary>
        [SerializeField]
        private UnityEngine.UI.Slider UISlider_EffectQualitySetting;

        /// <summary>
        /// Text hiển thị thiết lập chất lượng hiệu ứng
        /// </summary>
        [SerializeField]
        private TextMeshProUGUI UIText_EffectQualitySetting;
        ...
        /// <summary>
        /// Vô hiệu hóa hiệu ứng đổ màu Glow
        /// </summary>
        public int EffectQualitySetting
        {
            get
            {
                return (int) this.UISlider_EffectQualitySetting.value;
            }
            set
            {
                this.UISlider_EffectQualitySetting.value = value;
                /// Gọi sự kiện để cập nhật giá trị vào Text
                this.SliderEffectQualitySetting_ValueChanged(value);
            }
        }
        #endregion
        ...
        private void InitPrefabs()
        {
            ...
            this.UISlider_EffectQualitySetting.onValueChanged.AddListener(this.SliderEffectQualitySetting_ValueChanged);
        }
        ...
        /// <summary>
        /// Sự kiện khi giá trị của Slider thiết lập hiển thị hiệu ứng thay đổi
        /// </summary>
        /// <param name="value"></param>
        private void SliderEffectQualitySetting_ValueChanged(float value)
        {
            int valueInt = (int) value;
            if (valueInt == 0)
            {
                this.UIText_EffectQualitySetting.text = "Vô hiệu hóa";
            }
            else if (valueInt == 1)
            {
                this.UIText_EffectQualitySetting.text = "Trung bình";
            }
            else if (valueInt == 2)
            {
                this.UIText_EffectQualitySetting.text = "Vừa";
            }
            else if (valueInt == 3)
            {
                this.UIText_EffectQualitySetting.text = "Cao";
            }
        }
        #endregion
