...
namespace FSPlay.KiemVu.UI.Main
{
    ...
    public class UIChat : MonoBehaviour
    {
        ...
        private static readonly Dictionary<ChatChannel, Queue<SpriteChat>> chatListData = new Dictionary<ChatChannel, Queue<SpriteChat>>()
        {
            ...
            {ChatChannel.Family, new Queue<SpriteChat>()},
        ...
        {
            KTGlobal.ShowMessageBox("Xác nhận xóa toàn bộ tin nhắn?", () => {
                UIChat.chatListData.Clear();
        ...
        private void BuildChatContentByChannel(ChatChannel channel)
        {
            ...
            /// Toàn bộ, đặc biệt
            if (channel == ChatChannel.All || channel == ChatChannel.Special)
            {
                /// Danh sách tin nhắn
        ...
        private void InitChannels()
        {
            ...
            this.UI_SelectChannelFrame.Channels[ChatChannel.Family] = "Gia tộc";
            ...
            this.CreateChannelToggle(ChatChannel.Family, "Gia tộc");
        ...
        public void AddMessage(SpriteChat chat)
        {
            if (UIChat.chatListData.TryGetValue((ChatChannel) chat.Channel, out Queue<SpriteChat> listChat))
            {
                ...
                if (chat.Channel == (int) this.currentChannel || this.currentChannel == ChatChannel.Special || this.currentChannel == ChatChannel.All || (this.currentChannel == ChatChannel.System && chat.Channel == (int) ChatChannel.System_Broad_Chat))
                {
