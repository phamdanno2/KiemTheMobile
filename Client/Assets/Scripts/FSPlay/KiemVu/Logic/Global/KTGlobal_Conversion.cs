...
namespace FSPlay.KiemVu
{
    ...
    public static partial class KTGlobal
    {
        ...
        /// </summary>
        private const string MoneyIconBundleDir = "MainGame/Bag.unity3d";
        /// <summary>
        /// Atlas chứa Icon tiền tệ
        /// </summary>
        private const string MoneyIconAtlasName = "Bag";
        /// <summary>
        ...
        private static readonly Dictionary<MoneyType, string> MoneySpriteName = new Dictionary<MoneyType, string>()
        {
            ...
            { MoneyType.BacKhoa, "Icon_BacKhoa" },
            { MoneyType.Dong, "Icon_Gold" },
            { MoneyType.DongKhoa, "Icon_GoldKhoa" },
        };
        ...
        #region Chức vụ Trong gia tộc
        /// <summary>
        /// Trả về tên chức vụ trong trong gia tộc
        /// </summary>
        /// <param name="familyRank"></param>
        /// <returns></returns>
        public static string GetFamilyRankName(int familyRank)
        {
            if (familyRank <= (int) FamilyRank.Member)
            {
                return "Thành viên";
            }
            else if (familyRank == (int) FamilyRank.Master)
            {
                return "Tộc trưởng";
            }
            else if (familyRank == (int) FamilyRank.ViceMaster)
            {
                return "Tộc phó";
            }
            else
