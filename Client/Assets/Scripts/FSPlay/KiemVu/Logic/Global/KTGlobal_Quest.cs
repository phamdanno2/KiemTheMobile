...
namespace FSPlay.KiemVu
{
    ...
    public static partial class KTGlobal
    {
        ...
        {
            { NPCTaskStates.ToReceive_MainQuest, 11 },
            { NPCTaskStates.ToReturn_MainQuest, 12 },
            { NPCTaskStates.ToReceive_SubQuest, 67 },
            { NPCTaskStates.ToReturn_SubQuest, 68 },
            { NPCTaskStates.ToReceive_DailyQuest, 56 },
            { NPCTaskStates.ToReturn_DailyQuest, 57 },
        };

        /// <summary>
        /// Hiệu ứng nhận nhiệm vụ của nhân vật
        /// </summary>
        private static readonly int RoleReceiveTaskEffect = 83;
        /// <summary>
        /// Hiệu ứng hoàn thành nhiệm vụ của nhân vật
        /// </summary>
        private static readonly int RoleCompleteTaskEffect = 85;
        ...
        {
            return PlayZone.GlobalPlayZone.IsProgressBarVisible();
        }
                ...
                case (int) TaskTypes.UseSomething:
                {
                    ...
                    if (Loader.Loader.ListMonsters.TryGetValue(destNPCID, out MonsterDataXML _npcData))
                    {
                        ...
                        if (Global.Data.GameScene.MapCode == destMapCode)
                        {
                            ...
                            if (posX == -1 || posY == -1)
                            {
                                if (Global.Data.GameScene.CurrentMapData.NpcListByID.TryGetValue(destNPCID, out Drawing.Point point))
                                {
                                    posX = point.X;
                                    posY = point.Y;
                                }
        ...
        public static void QuestAutoFindPathToNPC(int mapCode, int npcID, Action moveDone)
        {
            ...
            if (Global.Data.GameScene.CurrentMapData.NpcListByID != null && Global.Data.GameScene.CurrentMapData.NpcListByID.TryGetValue(npcID, out Drawing.Point npcPos))
            {
        ...
        public static void QuestAutoFindPathToMonster(int mapCode, int monsterID, Action moveDone)
        {
            ...
            if (Global.Data.GameScene.CurrentMapData.MonsterListByID != null && Global.Data.GameScene.CurrentMapData.MonsterListByID.TryGetValue(monsterID, out Drawing.Point npcPos))
            {
                KTGlobal.QuestAutoFindPath(mapCode, npcPos.X, npcPos.Y, moveDone);
            }
        }
        ...
        public static void QuestAutoFindPathToGrowPoint(int mapCode, int growPointID, Action moveDone)
        {
            ...
            if (Global.Data.GameScene.CurrentMapData.GrowPointListByID != null && Global.Data.GameScene.CurrentMapData.GrowPointListByID.TryGetValue(growPointID, out Drawing.Point npcPos))
            {
                KTGlobal.QuestAutoFindPath(mapCode, npcPos.X, npcPos.Y, moveDone);
            }
        }
        ...
        public static void QuestAutoFindPath(int mapCode, int posX, int posY, Action moveDone)
        {
            ...
            PlayZone.GlobalPlayZone.ShowTextAutoFindPath();
