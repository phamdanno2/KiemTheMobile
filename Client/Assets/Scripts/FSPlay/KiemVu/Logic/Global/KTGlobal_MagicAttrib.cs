        ...
        public static string GetAttributeDescription(KMagicAttrib attrib)
        {
            ...
            switch (attrib.nAttribType)
            {
                ...
                case MAGIC_ATTRIB.magic_staticmagicshieldmax_p:
                    result = string.Format(PropertyDefine.PropertiesByID[(int) MAGIC_ATTRIB.magic_staticmagicshieldmax_p].Description, attrib.nValue[0].AttributeToString(), attrib.nValue[1]);
                    break;
                ...
                case MAGIC_ATTRIB.magic_infectpoison:
                    result = string.Format(PropertyDefine.PropertiesByID[(int) MAGIC_ATTRIB.magic_infectpoison].Description, attrib.nValue[0]);
                    break;
                ...
                case MAGIC_ATTRIB.magic_skilladdition_addskilllevel:
                    result = string.Format(PropertyDefine.PropertiesByID[(int) MAGIC_ATTRIB.magic_skilladdition_addskilllevel].Description, attrib.nValue[0], attrib.nValue[1], attrib.nValue[2]);
                    break;
            }
