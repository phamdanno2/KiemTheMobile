...
public partial class PlayZone
{
    ...
    public void ShowNPCLuaDialog(int npcID, int dialogID, string content, Dictionary<int, string> selections, List<DialogItemSelectionInfo> items, bool itemSelectable, Dictionary<int, string> otherParams)
    {
        GSprite npc = null;
        if (npcID > 0)
        {
            npc = scene.FindSprite(SpriteBaseIds.NpcBaseId + npcID);
        }
    ...
    public void ShowNPCLuaDialog(int itemID, int itemDbID, int dialogID, string content, Dictionary<int, string> selections, List<DialogItemSelectionInfo> items, bool itemSelectable, Dictionary<int, string> otherParams)
    {
