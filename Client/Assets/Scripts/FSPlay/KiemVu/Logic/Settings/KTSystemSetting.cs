...
namespace FSPlay.KiemVu.Logic.Settings
{
    ...
    public static partial class KTSystemSetting
    {
        ...
        private static Dictionary<SystemSettingIndex, object> _Settings = new Dictionary<SystemSettingIndex, object>()
        {
            ...
            { SystemSettingIndex.EffectQualitySetting, 1 },
        };
        /// <summary>
        /// Danh sách thiết lập hệ thống
        /// </summary>
        ...
        /// <summary>
        /// Thiết lập chất lượng hiệu ứng
        /// <para>0: Vô hiệu hóa Post Processing, 1: Post Processing tầm thấp, 2: Post Processing tầm trung, 3: Post Processing tầm cao</para>
        /// </summary>
        public static int EffectQualitySetting
        {
            get
            {
                return (int) KTSystemSetting.Settings[SystemSettingIndex.EffectQualitySetting];
            }
            set
            {
                KTSystemSetting.Settings[SystemSettingIndex.EffectQualitySetting] = value;
            }
        }
        #endregion
        ...
        public static void BuildSettings()
        {
            ...
            if (data.Length != (int) SystemSettingIndex.Count)
            {
                ...
                KTSystemSetting.EffectQualitySetting = 3;
#endif
            }
            else
            {
                ...
                KTSystemSetting.EffectQualitySetting = Utils.ParseNumber(data[(int) SystemSettingIndex.EffectQualitySetting], 1);
#if UNITY_ANDROID && !UNITY_EDITOR
                KTSystemSetting.EffectQualitySetting = Utils.ParseNumber(data[(int) SystemSettingIndex.EffectQualitySetting], 1);
#elif UNITY_IPHONE || UNITY_EDITOR
                KTSystemSetting.EffectQualitySetting = Utils.ParseNumber(data[(int) SystemSettingIndex.EffectQualitySetting], 3);
#endif
            }
        }
        ...
        public static void SaveSettings()
        {
            ...
            data.Add(KTSystemSetting.EffectQualitySetting.ToString());
